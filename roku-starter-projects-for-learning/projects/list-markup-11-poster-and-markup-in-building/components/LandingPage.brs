...
sub markupList()
    ...
    m.markuplist.translation=[800,300]
    m.markuplist.itemComponentName="MarkupListItem" 
    m.markuplist.content = CreateObject("roSGNode","MarkupListContent")
    m.markuplist.itemSize=[100,100]
    m.markuplist.itemSpacing=[0,10]
