sub init()
    ...
    m.names = ["bugs","bunny","lion","king","freddy","flintstone"]
    ...
    m.listmarkup.translation = [300,0]
...
sub onLabelListItemFocused()
    itemIndex = m.labellist.itemFocused
    print "index of item selected is " itemIndex
    m.poster.uri = m.posterUrls[itemIndex]
end sub
sub onLabelListItemSelected()
    print "item selected"
    index = m.labellist.itemSelected
