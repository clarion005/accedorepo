function init()
   ...
   m.poster = m.top.FindNode("videoIcon")
...
function onPlaybackStateChanged() as void
    print "m.video.state is " m.video.state
    if (m.video.state = "playing")
       print "video has finished buffering and is now playing so remove splash screen and make video visible"
