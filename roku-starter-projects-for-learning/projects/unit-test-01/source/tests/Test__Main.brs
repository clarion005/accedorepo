...
Function TestSuite__Main() as Object
    ...
    this.addTest("PhilTest",TestCase__Main_PhilTest)
...
'----------------------------------------------------------------
Function TestCase__Main_PhilTest() as String 
   return m.assertEqual("test","test")
End Function 

sub TestCase__Main_CheckItemAttributes_Setup()
    print "--- CheckItemAttributes Test Setup function"
    m.someVariable = "test"
end sub
...
Function TestCase__Main_CheckItemAttributes() as String
    ...
    print "Access some variable: " m.testinstance.someVariable
...
sub TestCase__Main_CheckItemAttributes_TearDown()
    print "--- CheckItemAttributes Test TearDown function"
end sub
