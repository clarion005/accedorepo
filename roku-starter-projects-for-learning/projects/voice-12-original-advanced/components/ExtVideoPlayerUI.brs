...
Function showThumbnails(position)
    m.trickPosition = Fix(position / 5) + 1
    print "m.trickPosition= ", m.trickPosition
    ...
    for i = startIndex to endIndex
      ...
      print "show - poster i="  i; ", position="  position; ", uri="  m.arrayPosters[i].uri
    end for
end Function
...
Function shiftThumbnailsLeft()    ' forward direction'
  ...
  ''print "shift left - thumb 4 uri= "  m.arrayPosters[4].uri
end Function
...
Function shiftThumbnailsRight()   ' reverse direction'
  ...
  ''print "shift right - thumb 0 uri= "  m.arrayPosters[0].uri
end Function
